...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    resulttwo = [2, 3, 4].inject(1) { |product, item| product * item }

    # Extra Credit:
    # Describe in your own words what inject does.
    # it takes a range or array of numbers
    # When we called the inject method, will pass each element and accumulate each sequentially.
  end
